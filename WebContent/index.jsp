							...
							<div class='card' style="with: 100%">
								<div class="card-body" style="padding-right: 30px">
									<es:aggregationIterator>
											<es:aggregation>
												<c:set var="aggregationCount"><es:aggregationCount /></c:set>
													...
													<ol class="facetList">
														<es:aggregationTermIterator>
															<li><input type="checkbox" id="index"
																...
																value="<es:aggregationTerm />" class="form-check-input" <es:aggregationTermStatus request="${pageContext.request}"/> >
